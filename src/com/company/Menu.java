...
public class Menu extends JFrame implements Serializable {
    public Menu() {
        ...
        //Submit button to change player name
        ...
        //Submit button to change computer name
        ...
        //JComboBox to choose piece style
        ...
        //JComboBox to choose board style
        ...
        //JComboBox to choose style (White / Black)
        ...
        //JComboBox to choose window size
        ...
        playButton.addActionListener(e -> {
            if (e.getActionCommand().equals("PLAY")) {
                ...
                ChessFrame view = new ChessFrame(controller, model);
...
//Preview of piece & board style
class MenuShowcase extends JPanel implements Serializable {
    @Override
